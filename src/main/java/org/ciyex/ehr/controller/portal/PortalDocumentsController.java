...
import org.ciyex.ehr.service.VitalsService;
...
public class PortalDocumentsController {
    ...
    public ApiResponse<List<DocumentDto>> getMyDocuments(Authentication authentication) {
        ...
        try {
            ...
            org.ciyex.ehr.dto.ApiResponse<List<DocumentDto>> documentsResponse = sharedDocumentService.getAllForPatient(ehrPatientId);
