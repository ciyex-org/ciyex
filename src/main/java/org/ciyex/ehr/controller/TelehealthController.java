...
import org.ciyex.ehr.service.telehealth.CloudflareTelehealthService;
import org.ciyex.ehr.service.telehealth.JitsiTelehealthService;
...
public class TelehealthController {
    ...
    public TelehealthController(ApplicationContext applicationContext, org.ciyex.ehr.util.OrgIntegrationConfigProvider configProvider) {
    ...
    private void setTenantContextFromJwt(HttpServletRequest request) {
        try {
            org.ciyex.ehr.dto.integration.RequestContext ctx = new org.ciyex.ehr.dto.integration.RequestContext();
            org.ciyex.ehr.dto.integration.RequestContext.set(ctx);
